    ...
    public class GoogleDriveImportService : IGoogleDriveImportService, IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("==================OPERATION SUCCEEDS==================");
            }
            catch (Exception ex)
            {
        ...
        public async Task ImportSales()
        {
            ...
            foreach (var station in stations)
            {
                if (station.FolderPath != "No Salestext")
                {
                    ...
                    try
                    {
                        ...
                        {
                            _logger.LogInformation($"=====IMPORTING {station.StationName} SALES: {file.FileName}=====");
            ...
            _logger.LogInformation($"=====SALES IMPORT COMPLETE=====");
        }
            ...
            foreach (var station in stations)
            {
                if (station.FolderPath != "No SalesText")
                {
                    ...
                    try
                    {
                        ...
                        foreach (var file in files)
                        {
                            _logger.LogInformation($"=====IMPORTING {station.StationName} PURCHASES: {file.FileName}=====");
