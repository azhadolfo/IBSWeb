...
namespace IBS.DataAccess.Repository.Filpride.IRepository
{
    ...
    {
        Task<bool> HasAlreadyBeginningInventory(int productId, int poId, CancellationToken cancellationToken = default);

        Task AddBeginningInventory(BeginningInventoryViewModel viewModel, CancellationToken cancellationToken = default);
        ...
        Task AddActualInventory(ActualInventoryViewModel viewModel, CancellationToken cancellationToken = default);
