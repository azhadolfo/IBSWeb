...
namespace IBS.DataAccess.Migrations
{
    ...
    [Migration("20240612012631_ApplyTheNamingConventionOfPostgreSql")]
    partial class ApplyTheNamingConventionOfPostgreSql
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IBS.Models.Fuel", b =>
                {
                    ...
                    b.HasIndex("INV_DATE")
                        .HasDatabaseName("ix_fuels_inv_date");

                    b.HasIndex("IsProcessed")
                        .HasDatabaseName("ix_fuels_is_processed");

                    b.HasIndex("ItemCode")
                        .HasDatabaseName("ix_fuels_item_code");

                    b.HasIndex("Particulars")
                        .HasDatabaseName("ix_fuels_particulars");

                    b.HasIndex("Shift")
                        .HasDatabaseName("ix_fuels_shift");

                    b.HasIndex("xONAME")
                        .HasDatabaseName("ix_fuels_x_oname");

                    b.HasIndex("xPUMP")
                        .HasDatabaseName("ix_fuels_x_pump");

                    b.HasIndex("xSITECODE")
                        .HasDatabaseName("ix_fuels_x_sitecode");
            ...
            modelBuilder.Entity("IBS.Models.FuelDelivery", b =>
                {
                    ...
                    b.HasKey("FuelDeliveryId")
                        .HasName("pk_fuel_deliveries");

                    b.HasIndex("shiftrecid")
                        .HasDatabaseName("ix_fuel_deliveries_shiftrecid");

                    b.HasIndex("stncode")
                        .HasDatabaseName("ix_fuel_deliveries_stncode");
            ...
            modelBuilder.Entity("IBS.Models.FuelPurchase", b =>
                {
                    ...
                    b.HasKey("FuelPurchaseId")
                        .HasName("pk_fuel_purchase");

                    b.HasIndex("FuelPurchaseNo")
                        .IsUnique()
                        .HasDatabaseName("ix_fuel_purchase_fuel_purchase_no");

                    b.HasIndex("ProductCode")
                        .HasDatabaseName("ix_fuel_purchase_product_code");

                    b.HasIndex("StationCode")
                        .HasDatabaseName("ix_fuel_purchase_station_code");

                    b.ToTable("fuel_purchase", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.Lube", b =>
                {
                    ...
                    b.HasIndex("Cashier")
                        .HasDatabaseName("ix_lubes_cashier");

                    b.HasIndex("INV_DATE")
                        .HasDatabaseName("ix_lubes_inv_date");
            ...
            modelBuilder.Entity("IBS.Models.LubeDelivery", b =>
                {
                    ...
                    b.HasKey("LubeDeliveryId")
                        .HasName("pk_lube_deliveries");

                    b.HasIndex("dtllink")
                        .HasDatabaseName("ix_lube_deliveries_dtllink");

                    b.HasIndex("shiftrecid")
                        .HasDatabaseName("ix_lube_deliveries_shiftrecid");

                    b.HasIndex("stncode")
                        .HasDatabaseName("ix_lube_deliveries_stncode");

                    b.ToTable("lube_deliveries", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.LubePurchaseDetail", b =>
                {
                    ...
                    b.HasKey("LubePurchaseDetailId")
                        .HasName("pk_lube_purchase_details");

                    b.HasIndex("LubePurchaseHeaderId")
                        .HasDatabaseName("ix_lube_purchase_details_lube_purchase_header_id");

                    b.HasIndex("LubePurchaseHeaderNo")
                        .HasDatabaseName("ix_lube_purchase_details_lube_purchase_header_no");

                    b.HasIndex("ProductCode")
                        .HasDatabaseName("ix_lube_purchase_details_product_code");

                    b.ToTable("lube_purchase_details", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.LubePurchaseHeader", b =>
                {
                    ...
                    b.HasKey("LubePurchaseHeaderId")
                        .HasName("pk_lube_purchase_headers");

                    b.HasIndex("LubePurchaseHeaderNo")
                        .IsUnique()
                        .HasDatabaseName("ix_lube_purchase_headers_lube_purchase_header_no");

                    b.HasIndex("StationCode")
                        .HasDatabaseName("ix_lube_purchase_headers_station_code");

                    b.ToTable("lube_purchase_headers", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.Offline", b =>
                {
                    ...
                    b.ToTable("offlines", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.POSales", b =>
                {
                    ...
                    b.HasIndex("POSalesNo")
                        .IsUnique()
                        .HasDatabaseName("ix_po_sales_po_sales_no");

                    b.ToTable("po_sales", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.PoSalesRaw", b =>
                {
                    ...
                    b.HasKey("POSalesRawId")
                        .HasName("pk_po_sales_raw");

                    b.HasIndex("shiftrecid")
                        .HasDatabaseName("ix_po_sales_raw_shiftrecid");

                    b.HasIndex("stncode")
                        .HasDatabaseName("ix_po_sales_raw_stncode");

                    b.HasIndex("tripticket")
                        .HasDatabaseName("ix_po_sales_raw_tripticket");

                    b.ToTable("po_sales_raw", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.SafeDrop", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_safe_drops");

                    b.HasIndex("INV_DATE")
                        .HasDatabaseName("ix_safe_drops_inv_date");

                    b.HasIndex("xONAME")
                        .HasDatabaseName("ix_safe_drops_x_oname");

                    b.ToTable("safe_drops", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.SalesDetail", b =>
                {
                    ...
                    b.HasIndex("SalesHeaderId")
                        .HasDatabaseName("ix_sales_details_sales_header_id");

                    b.HasIndex("SalesNo")
                        .HasDatabaseName("ix_sales_details_sales_no");

                    b.HasIndex("StationCode")
                        .HasDatabaseName("ix_sales_details_station_code");
            ...
            modelBuilder.Entity("IBS.Models.SalesHeader", b =>
                {
                    ...
                    b.HasKey("SalesHeaderId")
                        .HasName("pk_sales_headers");

                    b.HasIndex("Cashier")
                        .HasDatabaseName("ix_sales_headers_cashier");

                    b.HasIndex("Date")
                        .HasDatabaseName("ix_sales_headers_date");

                    b.HasIndex("SalesNo")
                        .HasDatabaseName("ix_sales_headers_sales_no");

                    b.HasIndex("Shift")
                        .HasDatabaseName("ix_sales_headers_shift");

                    b.HasIndex("StationCode")
                        .HasDatabaseName("ix_sales_headers_station_code");

                    b.ToTable("sales_headers", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.LubePurchaseDetail", b =>
                {
                    b.HasOne("IBS.Models.LubePurchaseHeader", "LubePurchaseHeader")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_lube_purchase_details_lube_purchase_headers_lube_purchase_h");
            ...
            modelBuilder.Entity("IBS.Models.SalesDetail", b =>
                {
                    b.HasOne("IBS.Models.SalesHeader", "SalesHeader")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_sales_details_sales_headers_sales_header_id");
