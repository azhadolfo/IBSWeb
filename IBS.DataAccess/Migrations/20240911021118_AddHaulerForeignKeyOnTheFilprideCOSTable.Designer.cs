...
namespace IBS.DataAccess.Migrations
{
    ...
    [Migration("20240911021118_AddHaulerForeignKeyOnTheFilprideCOSTable")]
    partial class AddHaulerForeignKeyOnTheFilprideCOSTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IBS.Models.Filpride.Integrated.FilprideCustomerOrderSlip", b =>
                {
                    ...
                    b.HasIndex("CommissionerId")
                        .HasDatabaseName("ix_filpride_customer_order_slips_commissioner_id");
            ...
            modelBuilder.Entity("IBS.Models.Filpride.MasterFile.FilprideHauler", b =>
                {
                    ...
                    b.HasIndex("HaulerCode")
                        .HasDatabaseName("ix_filpride_haulers_hauler_code");

                    b.HasIndex("HaulerName")
                        .HasDatabaseName("ix_filpride_haulers_hauler_name");
            ...
            modelBuilder.Entity("IBS.Models.Filpride.Integrated.FilprideCustomerOrderSlip", b =>
                {
                    b.HasOne("IBS.Models.Filpride.MasterFile.FilprideSupplier", "Commissioner")
                        .WithMany()
                    ...
                    b.HasOne("IBS.Models.Filpride.MasterFile.FilprideHauler", "Hauler")
                        .WithMany()
                        .HasForeignKey("HaulerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_filpride_customer_order_slips_filpride_haulers_hauler_id");
            ...
            modelBuilder.Entity("IBS.Models.Filpride.Integrated.FilprideDeliveryReceipt", b =>
                {
                    ...
                    b.HasOne("IBS.Models.Filpride.MasterFile.FilprideHauler", "Hauler")
                        ...
                        .HasForeignKey("HaulerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_filpride_delivery_receipts_filpride_haulers_hauler_id");
