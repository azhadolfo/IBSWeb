...
namespace IBSWeb.Areas.Filpride.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        #region -- Generate Collection Report Excel File --

        public async Task<IActionResult> GenerateCollectionReportExcelFile(ViewModelBook model, CancellationToken cancellationToken)
        {
            try
            {
                var dateFrom = model.DateFrom;
                ...
                var collectionReceiptReport = _unitOfWork.FilprideReport
                    .GetCollectionReport(model.DateFrom, model.DateTo, companyClaims);
            ...
            catch (Exception ex)
            {
                ...
                return RedirectToAction(nameof(CollectionReport));
            }
        }
